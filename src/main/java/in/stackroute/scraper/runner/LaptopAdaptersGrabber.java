...
public class LaptopAdaptersGrabber {
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver", "D:\\Code\\Java Workspace\\webdriver\\chromedriver88.exe");
		String base_url = "https://www.flipkart.com/laptop-accessories/laptop-adapters/pr?sid=6bo,ai3,8p1";
		...
		for (WebElement e : source_input) {
			...
			pro.setCategory("Laptop Adapters");
		...
		try {
			mapper.writeValue(new File("LaptopAdapters.json"), products);
