...
public class RouterGrabber {
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver", "D:\\Code\\Java Workspace\\webdriver\\chromedriver88.exe");
		String base_url = "https://www.flipkart.com/computers/network-components/routers/pr?sid=6bo%2C70k%2C2a2";
...
//				System.out.println(Arrays.toString(prices));
		...
		try {
			mapper.writeValue(new File("Router.json"), products);
