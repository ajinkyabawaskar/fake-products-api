...
public class LaptopCleaningGrabber {
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver", "D:\\Code\\Java Workspace\\webdriver\\chromedriver88.exe");
		String base_url = "https://www.flipkart.com/laptop-accessories/cleaning-kits/pr?sid=6bo%2Cai3%2Czy6";
		...
		for (WebElement e : source_input) {
			...
			pro.setCategory("Laptop Cleaning");
...
//				System.out.println(Arrays.toString(prices));
		...
		try {
			mapper.writeValue(new File("LaptopCleaning.json"), products);
