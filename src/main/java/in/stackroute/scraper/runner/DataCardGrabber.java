...
public class DataCardGrabber {
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver", "D:\\Code\\Java Workspace\\webdriver\\chromedriver88.exe");
		String base_url = "https://www.flipkart.com/computers/network-components/data-cards/pr?sid=6bo,70k,o47";
		...
		try {
			mapper.writeValue(new File("DataCards.json"), products);
