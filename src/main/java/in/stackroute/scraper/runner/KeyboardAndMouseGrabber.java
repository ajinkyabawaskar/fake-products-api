...
public class KeyboardAndMouseGrabber {
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver", "D:\\Code\\Java Workspace\\webdriver\\chromedriver88.exe");
		String base_url = "https://www.flipkart.com/laptop-accessories/keyboards/pr?sid=6bo%2Cai3%2C3oe";
		...
		for (WebElement e : source_input) {
			...
			pro.setCategory("Keyboards and Mouse");
...
//				System.out.println(Arrays.toString(prices));
		...
		try {
			mapper.writeValue(new File("KeyboardAndMouse.json"), products);
